...
app.all('/login', (req, res) => {
  // conn.query('SELECT * FORM students', (e, r) =>
    res.json(new Result({ success:true,msg:'hello message',value: {
      name:'小明',
      age:19,
      gender:'男'
    }}))
...
function Result({success=true, code = 1, msg = '', value = {} }) {
  (this.success = success),(this.code = code), (this.msg = msg), (this.value = value);
}
